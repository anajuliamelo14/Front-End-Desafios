...
function criarLinhaNaTabela(cliente) {
    ...
    tdAcoes.innerHTML = `<button onclick="editarCliente(${cliente.id})" class="btn btn-outline-sucess btn-sm mr-3">
                             Editar
                         </button>
                         <button onclick="excluirCliente(${cliente.id})" class="btn btn-outline-sucess btn-sm mr-3">
                             Excluir
                         </button>`;
